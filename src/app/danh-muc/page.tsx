          ...
          {searchTerm ? (
            <div className={styles.subCatList}>
              {searchResults.length > 0 ? searchResults.map((cat) => (
                <Link href={`/danh-muc/${cat.id}`} key={cat.id} className={styles.subCatItem} id={`search-cat-${cat.id}`}>
                  ...
                  <div className={styles.subCatInfo}>
                    <div className={styles.subCatName}>{cat.name}</div>
                    <div className={styles.subCatCount}>
                      {cat.parent_id ? 'Danh mục con' : 'Danh mục chính'}
                    </div>
                  </div>
              ...
              {subCategories.length > 0 && (
                <div className={styles.subCatList}>
                  {subCategories.map((sub) => (
                    <Link href={`/danh-muc/${sub.id}`} key={sub.id} className={styles.subCatItem} id={`subcat-${sub.id}`}>
                      <div className={styles.subCatImg}>
